const data_me = {
    "en": [{
        name: "ERIC TURNER",
        jobtitle: "Developer, Data & Cyber Enthusiast",
        desc: "I am a talented integration developer with almost 5 years of experience. I am familiar with many languages and stacks: Python, MySQL, SQL Server, SSIS, PHP MVC, React, & Wordpress. I am also CompTIA Security+ ce, PenTest+ ce and CNVP certified and I look towards growing my experience in cybersecurity!",
        cta_resume: "My Résumé",
        cta_contact: "Contact Me"
    }],
    "it": [{
        name: "ERIC TURNER",
        jobtitle: "Sviluppatore, appassionato di dati e cyber",
